// src/components/modules/rnn/components/workflow/WordVectorNode.tsx
...
export function WordVectorNode({ data }: WordVectorNodeProps) {
  ...
  // Highlight non-zero cells (for one-hot vectors)
  const getHighlight = () => {
        ...
        <div className="text-center mb-3">
          ...
          {data.vocabulary && (
            <div className="mt-1 flex justify-center gap-2 text-xs">
              <span className={isDark ? 'text-slate-400' : 'text-slate-500'}>Vocab:</span>
